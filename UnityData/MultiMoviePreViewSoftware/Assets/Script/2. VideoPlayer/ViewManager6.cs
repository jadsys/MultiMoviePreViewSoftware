...
public class ViewManager6 : MonoBehaviour {
    ...
    void Update () {
        ...
        if (Input.GetKeyUp(KeyCode.Alpha1))
        {
            if (!isZoom[0]) {
                ...
                Cam[1].rect = new Rect(0.9f, 0.82f, 0.1f, 0.18f);
                Cam[2].rect = new Rect(0.9f, 0.64f, 0.1f, 0.18f);
                Cam[3].rect = new Rect(0.9f, 0.46f, 0.1f, 0.18f);
                Cam[4].rect = new Rect(0.9f, 0.28f, 0.1f, 0.18f);
                Cam[5].rect = new Rect(0.9f,  0.1f, 0.1f, 0.18f);
        ...
        if (Input.GetKeyUp(KeyCode.Alpha2))
        {
            if (!isZoom[1])
            {
                Cam[0].rect = new Rect(0.9f, 0.82f, 0.1f, 0.18f);
        ...
        if (Input.GetKeyUp(KeyCode.Alpha3))
        {
            ...
            {
                Cam[0].rect = new Rect(0.9f, 0.82f, 0.1f, 0.18f);
                Cam[1].rect = new Rect(0.9f, 0.64f, 0.1f, 0.18f);
        ...
        if (Input.GetKeyUp(KeyCode.Alpha4))
        {
            if (!isZoom[3])
            {
                Cam[0].rect = new Rect(0.9f, 0.82f, 0.1f, 0.18f);
                Cam[1].rect = new Rect(0.9f, 0.64f, 0.1f, 0.18f);
                Cam[2].rect = new Rect(0.9f, 0.46f, 0.1f, 0.18f);
        ...
        if (Input.GetKeyUp(KeyCode.Alpha5))
        {
            if (!isZoom[4])
            {
                ...
                Cam[1].rect = new Rect(0.9f, 0.64f, 0.1f, 0.18f);
                Cam[2].rect = new Rect(0.9f, 0.46f, 0.1f, 0.18f);
                Cam[3].rect = new Rect(0.9f, 0.28f, 0.1f, 0.18f);
        ...
        if (Input.GetKeyUp(KeyCode.Alpha6))
        {
            if (!isZoom[5])
            {
                ...
                Cam[2].rect = new Rect(0.9f, 0.46f, 0.1f, 0.18f);
                Cam[3].rect = new Rect(0.9f, 0.28f, 0.1f, 0.18f);
                Cam[4].rect = new Rect(0.9f, 0.1f, 0.1f, 0.18f);
    ...
    {
        Cam[0].rect = new Rect(0.0f, 0.7f, 0.5f, 0.3f);
        Cam[1].rect = new Rect(0.5f, 0.7f, 0.5f, 0.3f);
        Cam[2].rect = new Rect(0.0f, 0.4f, 0.5f, 0.3f);
        Cam[3].rect = new Rect(0.5f, 0.4f, 0.5f, 0.3f);
        Cam[4].rect = new Rect(0.0f, 0.1f, 0.5f, 0.3f);
        Cam[5].rect = new Rect(0.5f, 0.1f, 0.5f, 0.3f);

        Sd[0].transform.localPosition = new Vector3(-250.0f,  125.0f, 0.0f);
        Sd[1].transform.localPosition = new Vector3( 250.0f,  125.0f, 0.0f);
        Sd[2].transform.localPosition = new Vector3(-250.0f,  -40.0f, 0.0f);
        Sd[3].transform.localPosition = new Vector3( 250.0f,  -40.0f, 0.0f);
        Sd[4].transform.localPosition = new Vector3(-250.0f, -210.0f, 0.0f);
        Sd[5].transform.localPosition = new Vector3( 250.0f, -210.0f, 0.0f);
        ...
        FName[2].transform.localPosition = new Vector3(-550.0f,   80.0f, 0.0f);
        FName[3].transform.localPosition = new Vector3(   0.0f,   80.0f, 0.0f);
        FName[4].transform.localPosition = new Vector3(-550.0f, -105.0f, 0.0f);
        FName[5].transform.localPosition = new Vector3(   0.0f, -105.0f, 0.0f);

        DTime[0].transform.localPosition = new Vector3(-400.0f,  125.0f, 0.0f);
        DTime[1].transform.localPosition = new Vector3( 120.0f,  125.0f, 0.0f);
        DTime[2].transform.localPosition = new Vector3(-400.0f,  -55.0f, 0.0f);
        DTime[3].transform.localPosition = new Vector3( 120.0f,  -55.0f, 0.0f);
        DTime[4].transform.localPosition = new Vector3(-400.0f, -240.0f, 0.0f);
        DTime[5].transform.localPosition = new Vector3( 120.0f, -240.0f, 0.0f);

        ETime[0].transform.localPosition = new Vector3(-670.0f,  125.0f, 0.0f);
        ETime[1].transform.localPosition = new Vector3(-125.0f,  125.0f, 0.0f);
        ETime[2].transform.localPosition = new Vector3(-670.0f,  -55.0f, 0.0f);
        ETime[3].transform.localPosition = new Vector3(-125.0f,  -55.0f, 0.0f);
        ETime[4].transform.localPosition = new Vector3(-670.0f, -240.0f, 0.0f);
        ETime[5].transform.localPosition = new Vector3(-125.0f, -240.0f, 0.0f);
